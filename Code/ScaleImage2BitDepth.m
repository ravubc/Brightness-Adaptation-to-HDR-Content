...
if BT1361
    ...
    % Min and max value of the representation
    MaxValueY = ((256*1)   * 2^(BitDepth-8)) - 1;
    MinValueY = (255*0)   * 2^(BitDepth-8);
    MaxValueC = ((256 * 0.5  + 128) * 2^(BitDepth-8)) -1;
    MinValueC = ((-256 * 0.5 + 128) * 2^(BitDepth-8)) -1;
end
